...
## Summary
Okta treats devices and users as isolated objects, creating problems with deactivated user identities remaining tied to active devices in Okta. As a best practice, we deactivate and delete user devices during our offboarding process. These flows can be used to pull a list of devices associated with a user, ensure there are no active user identities using those devices, then deactivate and delete the devices from Okta.
...
<a href="https://github.com/wellwellelle"><img src="https://avatars.githubusercontent.com/u/57826707?v=4" title="yuval-hazaz" width="50" height="50"></a>
